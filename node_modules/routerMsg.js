...
exports.msgsent = function(req,res){
	...
	client.query(queryString, function(error, d){
		...
		var queryStringSentMsg = "insert into message (username,msgTag,targetProfile,sentmsg,msgTimestamp,towhom,selfProfile,selfFasleName,time) values('" +
...
exports.msgDetail = function(req,res){
	...
	client.query(queryString, function(error, d){
		...
		res.render("./msg/msgDetail.ejs",{"title":"聊天记录",'msgFound': JSON.stringify(msgFound)});
...
exports.changeNewMsgToOld = function(){
