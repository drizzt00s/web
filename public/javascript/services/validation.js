define(['angularAMD'], function(angularAMD){
	angularAMD.service('validation', function(errorMsg){
		...
		this.checkEmpty = function(checkEmptyObject){
			var storeError = [];
		...
		this.checkDefault = function(checkDefaultValObj){
			var storeDefault = [];
		...
		this.checkBirthday = function(birthdayObj){
			var storeBirthday = [];
		...
		this.checkMobileValidation = function(mobileNumber){
			var storeMobieError = [];
		...
		this.checkPasswordIdentity = function(pass, rePass){
		...
		this.checkPasswordComplexcity = function(pass){
